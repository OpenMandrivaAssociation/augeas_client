...
mkdir -p $RPM_BUILD_ROOT/var/local/augeas/
install -m 644 var/local/augeas/augeas.conf $RPM_BUILD_ROOT/var/local/augeas/
...
#%{_datadir}/pixmaps/%{name}.png
%{_datadir}/augeas_client.glade
/var/local/augeas/augeas.conf
%{_datadir}/locale/*
